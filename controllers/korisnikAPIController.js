...
exports.redimenzionisanjeKorisnickeSlike = catchAsync(async (req, res, next) => {
...
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  if (req.file) filteredBody.fotografija = req.file.filename;
   ...
   const azuriraniKorisnik = await Korisnik.findByIdAndUpdate(req.user.id, filteredBody, {
    new: true,
    runValidators: true
  });
...
exports.deleteMe = catchAsync(async (req, res, next) => {
  await Korisnik.findByIdAndUpdate(req.user.id, { active: false });
...
exports.getKorisnik = factory.getOne(Korisnik);
exports.getAll = factory.getAll(Korisnik);

 exports.updateKorisnik = factory.updateOne(Korisnik);
exports.deleteKorisnik = factory.deleteOne(Korisnik);
